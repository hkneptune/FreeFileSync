...
OptionsDlgGenerated::OptionsDlgGenerated( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    bSizer307->Add( m_staticText163, 0, wxALIGN_CENTER_VERTICAL, 5 );
    ...
    bSizer307->Add( m_hyperlinkLogFolder, 0, wxALIGN_CENTER_VERTICAL|wxLEFT, 5 );


    fgSizer25111->Add( bSizer307, 0, wxALIGN_CENTER_VERTICAL, 5 );
    ...
    m_spinCtrlLogFilesMaxAge = new wxSpinCtrl( m_panel39, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1, -1 ), wxSP_ARROW_KEYS, 1, 2000000000, 5 );
    ...
    bSizer166->Add( fgSizer25111, 0, wxALL, 10 );
